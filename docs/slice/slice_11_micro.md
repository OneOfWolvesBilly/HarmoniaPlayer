...
|---|---|---|---|
| 11-A | Enable complete strict-concurrency checking + record warning baseline | — | ⬜ |
...
## Slice 11-A: Enable Complete Checking + Record Baseline ⬜
...
- Docs: `docs/development_guide.md`, `docs/slice/slice_11_micro.md`
  (baseline table)
